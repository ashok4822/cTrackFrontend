...
import { Container, CheckCircle2, AlertCircle, Clock } from "lucide-react";
...
export function CustomerContainerSummary({ totalInYard, inTransit, damaged }: CustomerContainerSummaryProps) {
    return (
