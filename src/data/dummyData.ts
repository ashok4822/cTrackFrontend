...
export const dummyContainers: Container[] = [
  ...
  },
  {
    ...
    shippingLine: "Maersk Line",
    customer: "ABC Manufacturing",
    gateInTime: "2024-01-20T09:00:00Z",
    gateOutTime: "2024-01-22T10:30:00Z",
    dwellTime: 2,
    weight: 24000,
    sealNumber: "SEAL998877",
  },
  {
    id: "10",
    containerNumber: "TGHU5566778",
    size: "20ft",
    type: "standard",
    movementType: "import",
    status: "gate-out",
    shippingLine: "CMA CGM",
    customer: "Global Traders",
    gateInTime: "2024-01-19T11:00:00Z",
    gateOutTime: "2024-01-22T14:15:00Z",
    dwellTime: 3,
    weight: 15000,
  },
];
...
export const dummyAuditLogs: AuditLog[] = [
  {
    ...
    details: "Container YMLU4455667 gate in completed",
    timestamp: "2024-01-21T08:00:00Z",
  ...
  },
  {
    ...
    action: "Approval",
    module: "Approvals",
    details: "Approved stuffing request for KKFU1122334",
  ...
  },
  {
    ...
    module: "Surveys",
    details: "Completed survey for MSCU1234567",
...
export const dummyNotifications: Notification[] = [
  {
    ...
    message: "Container EITU5432109 reported with damage",
    read: false,
    timestamp: "2024-01-21T09:00:00Z",
    link: "/admin/containers/4",
  },
  {
    id: "2",
    type: "warning",
    title: "Pending Approval",
    message: "3 gate-out requests pending approval",
    read: false,
    timestamp: "2024-01-21T10:30:00Z",
  ...
  },
  {
    ...
    message: "Payment of ₹10,000 received from CMA CGM",
    read: true,
    timestamp: "2024-01-21T08:00:00Z",
  },
];
...
export const dummyBlocks: Block[] = [
  ...
  { id: "4", name: "Block R (Reefer)", capacity: 50, occupied: 35 },
  { id: "5", name: "Block D", capacity: 180, occupied: 120 },
];
...
export const dummyKPIData: KPIData = {
  ...
  recentActivities: [
    {
      id: "1",
      action: "Gate In",
      description: "Container YMLU4455667 entered via Gate A",
      time: "10 minutes ago",
      type: "gate",
    },
    {
    ...
    {
      id: "3",
      action: "Container Shifted",
      description: "MSCU1234567 moved to Block A, Row 01",
      time: "3 hours ago",
      type: "yard",
    },
  ],
  ...
  activeTasks: [
    ...
    },
    {
      ...
      status: "in-progress",
      containerNumber: "KKFU1122334",
      createdAt: new Date("2024-01-21T07:00:00Z"),
    },
    {
      id: "3",
      type: "relocation",
  ...
  equipmentStatusSummary: [
    { id: "1", name: "RS-001", type: "reach-stacker", status: "operational" },
    { id: "2", name: "RS-002", type: "reach-stacker", status: "operational" },
    { id: "3", name: "FL-001", type: "forklift", status: "maintenance" },
    { id: "4", name: "CR-001", type: "crane", status: "operational" },
    { id: "5", name: "SC-001", type: "crane", status: "down" },
  ],
};
...
export const dummyTasks = [
  {
    id: "1",
    type: "gate-in",
    description: "Process gate-in for NYKU8765432",
    status: "pending",
    priority: "normal",
  ...
  },
  {
    id: "2",
    type: "stuffing",
    description: "Complete stuffing for KKFU1122334",
    status: "in-progress",
    priority: "high",
    assignedTo: "Mike Operator",
  ...
  },
  {
    id: "3",
    type: "relocation",
    description: "Move MSCU1234567 to Block A",
    status: "pending",
    priority: "normal",
    assignedTo: "Mike Operator",
  ...
  },
  {
    id: "4",
    type: "inspection",
    description: "Pre-gate inspection for OOLU3210987",
    status: "completed",
    priority: "urgent",
    assignedTo: "Mike Operator",
...
export const dummyNominations = [
  {
    ...
    driverPhone: "+91 98765 43210",
    status: "pending",
    nominatedAt: "2024-01-21T08:30:00Z",
  },
  {
    id: "2",
    containerNumber: "HLCU7654321",
    shippingLine: "Hapag-Lloyd",
    customer: "XYZ Foods",
    factory: "XYZ Processing Unit",
    location: "Bangalore Industrial Zone",
    distance: "150 km",
    size: "20ft",
    type: "reefer",
    movementType: "export",
    ...
    driverPhone: "+91 87654 32109",
    status: "pending",
    nominatedAt: "2024-01-21T09:00:00Z",
  },
];
...
// Transit Checkpoints Data
export const dummyTransitCheckpoints: unknown[] = [
  {
    id: "1",
    containerId: "1",
    containerNumber: "MSCU1234567",
  ...
  },
  {
    ...
    checkpointName: "Terminal Gate",
    location: "ICD Terminal",
    arrivedAt: "2024-01-22T10:30:00Z",
    departedAt: "2024-01-22T11:00:00Z",
    status: "completed",
    remarks: "Gate-out completed",
  },
  {
    id: "8",
    containerId: "9",
    containerNumber: "TEXU9988776",
    checkpointName: "Highway Patrol Hub",
    location: "Poonamallee, Chennai",
    arrivedAt: "2024-01-22T12:00:00Z",
    status: "in-transit",
    remarks: "Regular transit check",
  },
];

// Transit Containers Summary (for listing)
export const dummyTransitContainers = [
  {
    id: "2",
    containerNumber: "HLCU7654321",
  ...
  },
  {
    ...
    eta: "2024-01-23T08:00:00Z",
  },
  {
    id: "10",
    containerNumber: "TGHU5566778",
    origin: "ICD Terminal",
    destination: "Global Traders Warehouse",
